"""
FinOps AWS - VPCLattice Service
Análise de custos e otimização para AWS VPCLattice
"""
...
@dataclass
class VPCLatticeResource:
    """Representa um recurso VPCLattice"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class VPCLatticeService(BaseAWSService):
    """Serviço FinOps para AWS VPCLattice"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "vpclattice"
