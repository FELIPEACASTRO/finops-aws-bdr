...
class TranscribeResource:
    """Representa um recurso de Transcribe."""
    resource_id: str
    name: str
    status: str = "ACTIVE"
...
class TranscribeService(BaseAWSService):
    """Serviço Transcribe."""
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            client = self._client_factory.get_client("transcribe")
            return {"status": "healthy"}
        except Exception as e:
            logger.error(f"Transcribe health check failed: {str(e)}")
