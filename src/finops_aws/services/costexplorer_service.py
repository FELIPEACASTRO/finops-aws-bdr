"""
FinOps AWS - CostExplorer Service
Análise de custos e otimização para AWS CostExplorer
"""
...
@dataclass
class CostExplorerResource:
    """Representa um recurso CostExplorer"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class CostExplorerService(BaseAWSService):
    """Serviço FinOps para AWS CostExplorer"""
