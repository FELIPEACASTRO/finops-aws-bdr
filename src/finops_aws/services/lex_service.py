"""AWS Lex Service - Conversational AI."""
...
class LexService(BaseAWSService):
    """Serviço Lex."""
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            client = self._client_factory.get_client("lex")
            return {"status": "healthy"}
        except Exception as e:
            logger.error(f"Lex health check failed: {str(e)}")
