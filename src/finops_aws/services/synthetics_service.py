"""
FinOps AWS - Synthetics Service
Análise de custos e otimização para AWS Synthetics
"""
...
class SyntheticsResource:
    """Representa um recurso Synthetics"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class SyntheticsService(BaseAWSService):
    """Serviço FinOps para AWS Synthetics"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "synthetics"
