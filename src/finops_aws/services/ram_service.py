"""
FinOps AWS - RAM Service
Análise de custos e otimização para AWS RAM
"""
...
class RAMService(BaseAWSService):
    """Serviço FinOps para AWS RAM"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "ram"
