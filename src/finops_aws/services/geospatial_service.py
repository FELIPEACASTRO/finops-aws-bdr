"""
FinOps AWS - GeoSpatial Service
Análise de custos e otimização para AWS GeoSpatial
"""
...
class GeoSpatialResource:
    """Representa um recurso GeoSpatial"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class GeoSpatialService(BaseAWSService):
    """Serviço FinOps para AWS GeoSpatial"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "geospatial"
