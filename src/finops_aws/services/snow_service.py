"""AWS Snow Service - Snow device management."""
...
class SnowService(BaseAWSService):
    """Serviço Snow."""
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            client = self._client_factory.get_client("snow")
            return {"status": "healthy"}
        except Exception as e:
            logger.error(f"Snow health check failed: {str(e)}")
