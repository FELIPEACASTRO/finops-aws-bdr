"""
FinOps AWS - FIS Service
Análise de custos e otimização para AWS FIS
"""
...
class FISService(BaseAWSService):
    """Serviço FinOps para AWS FIS"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "fis"
