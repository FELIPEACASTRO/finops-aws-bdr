"""
FinOps AWS - PrivateLink Service
Análise de custos e otimização para AWS PrivateLink
"""
...
class PrivateLinkResource:
    """Representa um recurso PrivateLink"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class PrivateLinkService(BaseAWSService):
    """Serviço FinOps para AWS PrivateLink"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "privatelink"
