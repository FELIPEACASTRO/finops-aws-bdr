"""AWS Forecast Service - Time series forecasting."""
...
class ForecastResource:
    """Representa um recurso de Forecast."""
    resource_id: str
    name: str
    status: str = "ACTIVE"
...
class ForecastService(BaseAWSService):
    """Serviço Forecast."""
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            client = self._client_factory.get_client("forecast")
