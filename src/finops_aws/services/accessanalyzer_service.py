"""
FinOps AWS - AccessAnalyzer Service
Análise de custos e otimização para AWS AccessAnalyzer
"""
...
@dataclass
class AccessAnalyzerResource:
    """Representa um recurso AccessAnalyzer"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class AccessAnalyzerService(BaseAWSService):
    """Serviço FinOps para AWS AccessAnalyzer"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "accessanalyzer"
