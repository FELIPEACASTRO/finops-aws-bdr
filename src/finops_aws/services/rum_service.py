"""
FinOps AWS - RUM Service
Análise de custos e otimização para AWS RUM
"""
...
class RUMService(BaseAWSService):
    """Serviço FinOps para AWS RUM"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "rum"
