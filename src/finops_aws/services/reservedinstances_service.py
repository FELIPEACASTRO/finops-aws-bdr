"""
FinOps AWS - ReservedInstances Service
Análise de custos e otimização para AWS ReservedInstances
"""
...
@dataclass
class ReservedInstancesResource:
    """Representa um recurso ReservedInstances"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class ReservedInstancesService(BaseAWSService):
    """Serviço FinOps para AWS ReservedInstances"""
    ...
    def get_resources(self) -> List[Dict[str, Any]]:
        """Obtém recursos ReservedInstances"""
        try:
            return []
