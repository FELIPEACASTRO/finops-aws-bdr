"""
FinOps AWS - IdentityCenter Service
Análise de custos e otimização para AWS IdentityCenter
"""
...
@dataclass
class IdentityCenterResource:
    """Representa um recurso IdentityCenter"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class IdentityCenterService(BaseAWSService):
    """Serviço FinOps para AWS IdentityCenter"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "identitycenter"
