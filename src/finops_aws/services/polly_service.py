...
@dataclass
class PollyResource:
    """Representa um recurso de Polly."""
    resource_id: str
    name: str
    status: str = "ACTIVE"
...
class PollyService(BaseAWSService):
    """Serviço Polly."""
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            client = self._client_factory.get_client("polly")
            return {"status": "healthy"}
        except Exception as e:
            logger.error(f"Polly health check failed: {str(e)}")
