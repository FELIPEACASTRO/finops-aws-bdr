"""
FinOps AWS - CodeArtifact Service
Análise de custos e otimização para AWS CodeArtifact
"""
...
@dataclass
class CodeArtifactResource:
    """Representa um recurso CodeArtifact"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class CodeArtifactService(BaseAWSService):
    """Serviço FinOps para AWS CodeArtifact"""
