"""AWS MQ Service - Message broker service."""
...
class MqService(BaseAWSService):
    """Serviço MQ."""
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            client = self._client_factory.get_client("mq")
            return {"status": "healthy"}
        except Exception as e:
            logger.error(f"MQ health check failed: {str(e)}")
