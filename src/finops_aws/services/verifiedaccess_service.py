"""
FinOps AWS - VerifiedAccess Service
Análise de custos e otimização para AWS VerifiedAccess
"""
...
@dataclass
class VerifiedAccessResource:
    """Representa um recurso VerifiedAccess"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class VerifiedAccessService(BaseAWSService):
    """Serviço FinOps para AWS VerifiedAccess"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "verifiedaccess"
