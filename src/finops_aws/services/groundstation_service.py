"""
FinOps AWS - GroundStation Service
Análise de custos e otimização para AWS GroundStation
"""
...
class GroundStationResource:
    """Representa um recurso GroundStation"""
    resource_id: str
    resource_type: str
    name: str
    region: str
...
class GroundStationService(BaseAWSService):
    """Serviço FinOps para AWS GroundStation"""
    
    def __init__(self, client_factory):
        super().__init__()
        self._client_factory = client_factory
        self.logger = setup_logger(self.__class__.__name__)
        self.service_name = "groundstation"
